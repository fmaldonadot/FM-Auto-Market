...
(11, 9, 1, '3', 'I like more Tesla Cars'),
(12, 9, 2, '4', 'Wonderful Car'),
(13, 9, 4, '1', 'Too much Kms'),
(14, 3, 1, '5', 'My Dream'),
(15, 3, 11, '3', 'My only Option'),
(16, 3, 8, '5', 'WOWWWWWW!!!!!'),
(17, 3, 8, '5', 'I can\'t to stop writing reviews abouts this Monster'),
(18, 7, 12, '3', 'Je voudrais acheter ̤a pour Lois Lane.  I don`t need a car.  I can fly... Its Better!!'),
(19, 7, 6, '4', 'Pour ma m̬re!!!!'),
(20, 7, 15, '5', 'Lex Luttor va se f̢cher quand il se rende en compte que j\'ai achet̩ cet voiture'),
(21, 10, 1, '4', 'Achet̩ toutes les voitures de cette page'),
(22, 10, 3, '4', 'Achet̩ toutes les voitures de cette page'),
(23, 10, 3, '5', 'Achet̩ toutes les voitures de cette page'),
(24, 10, 16, '5', 'Achet̩ toutes les voitures de cette page'),
(25, 10, 1, '5', 'Achet̩ toutes les voitures de cette page'),
(26, 10, 6, '5', 'Achet̩ toutes les voitures de cette page');
...
(10, 'Bruce', 'Wayne', 'Batman1500', '12345', 'batman@batcave.com');
...
--
ALTER TABLE `favoritescars`
  MODIFY `RefFavorite` int(64) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT for table `members`
--
ALTER TABLE `members`
  MODIFY `MemberID` int(64) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
