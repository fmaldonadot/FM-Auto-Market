		...
		<div>
			<table width="962px" height="40px" align="center" >
				<tr>
					...
					<td width="49" align="right"><a href="includes/logout.php" name="mdlLogout" id="mdlLogout">LOGOUT</a></td>		
					<td width="49" align="right"><a href="includes/favorites.php" name="mdlLogout" id="mdlLogout">FAVORITES</a></td>												
					<td width="46" align="right"><a href="includes/changeLanguage.php?lang='F'" title="Allez au Français"><img src="../img/french-flag-button-rectangular.png" width="46" height="30" /></a></td>
