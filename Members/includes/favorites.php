	...
	<div class="container">
		<div class="primary_header">
      		<table style="width: 100%;">
      			<tr>
					...
					<p class="auto-style1" style="font-family: Courgette; width: 555px;margin-top: 0px">My Favorites<br><?php echo $_SESSION["headerTitle"]?></p></td>
      			</tr>
      		</table>
    	</div>
		<div>
			<table width="962px" height="40px" align="center" >
				<tr>
					...
					<td width="46" align="right"><a href="changeLanguage.php" title="Allez au Français"><img src="../../img/french-flag-button-rectangular.png" width="46" height="30" /></a></td>
		...
		<center><div style="margin-top: 20px; margin-bottom: 20px; width: 550px;">
			...
			<?php 
				...
				{
					echo "<center><h3>You don't have any Favorites selected</h3></center>";
				}
			?>
