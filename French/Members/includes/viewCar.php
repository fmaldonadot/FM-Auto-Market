...
<div>
     	<table width="962px" height="40px" align="center" >
     		<tr>
      			<td width="46" align="right"><a href="../index.php" >ACCUEIL</a></td><td width="46" align="right"><a href="favorites.php" >FAVORIS</a></td>
        		<td width="46" align="right"><a href="changeLanguage.php" title="Allez au Français"><img src="../../img/United-Kingdom-Flag.png" width="46" height="30" /></a></td>
...
<div style="float: left; border: 1px solid black; width: 20%; padding: 10px; background-color: #125BB3" align="left">
	<p style="color: white">Écrivez un commentaire</p>
	<form action="#" method="post">
		<textarea name="txtReview" placeholder="Votre commentaire ici" style="font-size: 12px; text-align: left; width: 100%" required></textarea><br>
 	  ...
 	  <center><input type="submit" name="btnReview" value="Envoyer"></center>
    </form>
